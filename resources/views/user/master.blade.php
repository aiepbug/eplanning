		...
		<div class="header">
			...
			<nav>
			  <div class="nav-wrapper light-blue darken-4">
				<ul>
					<li {{ menu("biodata") }}><a href="#">Biodata</a></li>
					<li {{ menu("keluarga") }}><a href="#tentang">Keluarga</a></li>
					<li {{ menu("akademik") }}><a href="#tentang">Akademik</a></li>
					<li {{ menu("formasi") }}><a href="#tentang">Formasi</a></li>
				</ul>
