...
<div id="konten">
	<div class="fixed-action-btn horizontal" style="bottom: 45px; right: 24px;">
		...
		<ul>
			<li><a onclick="cetak('unit_tahun0',{{ $unit->id }})"class="btn blue darken-1">Perbandingan Tahun sebelumya</a></li>
			<li><a onclick="cetak('unit_tahun1',{{ $unit->id }})" class="btn red">Tahun ini</a></li>
		</ul>
	</div>
	...
	<h5>Perencanaan {{ $unit->nama_unit }} ({{ $tahun }})</h5> 
		...
		?>
			...
			<td>
				...
				@foreach($rincian as $r)
					<li>
						<!--<a onclick="editRincian('{{ $r->id }}')" href="javascript:void(0)"><i class="tiny material-icons">mode_edit</i></a>--> 
							{{ $r->rincian_kegiatan }} 
