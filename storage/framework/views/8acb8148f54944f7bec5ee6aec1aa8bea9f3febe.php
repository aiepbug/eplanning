			...
			<nav>
			  <div class="nav-wrapper light-blue darken-4">
				...
				<ul id="menu_default" class="hide-on-med-and-down">
					<li id="biodata"><a href="javascript:void(0)" class="dropdown-button" data-activates="dropdown-tahun"><i class="material-icons left">list</i> Data</a></li>
					<li id="biodata"><a href="javascript:void(0)" onclick="menu_cetak('tahun1')"><i class="large material-icons left">print</i> Cetak</a></li>
				</ul>
				<ul class="right hide-on-med-and-down">
<!--
					<li><a onclick="ubahtahun()">Tahun anggaran <?php echo e(session()->get('tahun')); ?> </a></li>
-->
	...
	<div id="konten">
		<h3><blockquote>Selamat datang, anda login sebagai :<br><?php echo e(session()->get('nama')); ?></blockquote></h3>
	</div>
	<ul id='dropdown-tahun' class='dropdown-content'>
		<li><a href="#!" onclick="input_data(<?php echo e((date('Y'))-1); ?>)"><?php echo e((date('Y'))-1); ?></a></li>
		<li><a href="#!" onclick="input_data(<?php echo e((date('Y'))); ?>)"><?php echo e((date('Y'))); ?></a></li>
		<li><a href="#!" onclick="input_data(<?php echo e((date('Y'))+1); ?>)"><?php echo e((date('Y'))+1); ?></a></li>
  </ul>
